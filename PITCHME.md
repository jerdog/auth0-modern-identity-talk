...
---?image=assets/images/kai-pilger-395931-unsplash.jpg&size=auto 90%
## @color[black]Authorization

* @color[black]Ensure the user has the right access at the right time
* @color[black]Change and revoke access
